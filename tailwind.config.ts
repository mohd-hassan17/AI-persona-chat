...
export default {
	...
	theme: {
		...
		extend: {
			colors: {
				...
				"chat-user": "#A855F7",           // purple
      "chat-user-foreground": "#fff",
      "chat-hitesh": "#22C55E",         // green
      "chat-hitesh-foreground": "#fff",
      "chat-piyush": "#3B82F6",         // blue
      "chat-piyush-foreground": "#fff",
    ...
    "user-foreground": "#fff",
    hitesh: "#22C55E", // green
    "hitesh-foreground": "#fff",
    piyush: "#3B82F6", // blue
    "piyush-foreground": "#fff",
    background: "#111827",
  },
				sidebar: {
